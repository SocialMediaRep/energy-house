          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gray-50 p-4 rounded-2xl border border-gray-200">
              ...
              <div className="relative">
                ...
                {/* Tooltip */}
                {showSavingsTooltip && (
                  <div className="absolute left-0 bottom-0 m-0 w-80 bg-white rounded-lg shadow-lg border border-gray-200 p-4 z-[9999] visible translate-x-[-150px] translate-y-[-50px]
">
                    {/* Close Button */}
                    <button
