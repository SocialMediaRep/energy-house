...
export const GlobalPowerControl: React.FC<GlobalPowerControlProps> = ({
  ...
  return (
    <button
      ...
      className="group relative flex items-center justify-center space-x-2 w-full py-2 px-3 bg-repower-gray-100 border border-repower-gray-200 hover:bg-repower-red rounded-lg transition-all duration-200 cursor-pointer"
