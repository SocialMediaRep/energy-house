...
export const DeviceChart: React.FC<DeviceChartProps> = ({ device }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-4 border border-slate-200">
      ...
      {/* Chart */}
      <div className="h-40 relative bg-white rounded-xl p-3 overflow-hidden border border-gray-200 z-0">
        {/* Background grid */}
        ...
        {/* Max value indicator */}
        <div className="absolute top-2 left-3 text-xs text-gray-500 bg-white px-2 py-1 rounded border z-0">
          Max: {Math.round(maxConsumption)}W
        </div>

        {/* Device category indicator */}
        <div className="absolute top-2 right-3 text-xs text-white bg-slate-600 px-2 py-1 rounded z-0">
